...
for each in [693, 1386, 2079, 2772, 3465, 4158, 4851, 5544, 6237, 6930]:
    ...
    print("\n######## TC ########\n")
    get_results(tc_test_lines, tc_labels, dataset_and_split="tc_test")

    print("\n######## PC ########\n")
    get_results(pc_test_lines, pc_labels, dataset_and_split="pc_test")

    print("\n######## TC TRAIN ########\n")
    get_results(tc_test_on_train_lines[:400], tc_test_on_train_labels[:500], dataset_and_split="tc_train")

    print("\n######## PC TRAIN ########\n")
    get_results(pc_test_on_train_lines[:400], pc_test_on_train_labels[:500], dataset_and_split="pc_train")
